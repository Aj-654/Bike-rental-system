...
root = Tk()
root.title('Know More About TVS Splendor')
...
heading = Label(root,text='TVS Raider Reviews',bg='white',font=('Microsoft YaHei UI Light',25,'bold'))
...
subhead1=Label(root,text='Closer View of TVS Raider',bg='white',font=('Microsoft YaHei UI Light',23,'bold'))
subhead1.place(x=20,y=470)
image1 = Image.open("traider1.png")
image2 = Image.open("traider2.png")
image3 = Image.open('traider3.png')
image4 = Image.open('traider4.png')
# Resize the images
